...
${realme}=  xpath=  //android.widget.TextView[@text="realme 8i (Space Black, 64 GB)"]
...
User Searches for mobile
    ...
    Wait Until Page Contains    realme 8i    timeout=100s
...
Verify if mobile is added to cart
    ...
    Log to console   realme  is added to cart
